...
/**
 * Wikimedia exports support multi-stream files that contain multiple BZIP2 streams. To find data in these files an index
 * is published that contains line-separated entries of the form: `bytesToSeek:articleId:pageTitle`. This parser extracts
 * a {@link TreeSet} of these entries.
 *
